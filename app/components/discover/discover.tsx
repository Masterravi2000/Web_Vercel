...
const SportsCommunitySection: FC = () => {
  ...
  return (
    <div className="hidden md:block mt-24 bg-[#121112] rounded-3xl pt-12 mx-[120px] max-[1496px]:mx-8 max-[900px]:mx-8 max-[800px]:mx-3 max-[700px]:h-fit border-[2px] border-[#303030] flex flex-col gap-y-4" id="community">
    <h1
