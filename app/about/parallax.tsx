...
export default function ParallaxScreen() {
  useEffect(() => {
    ...
    animateValue("totalUsers", 0, 658, 3000);
    animateValue("totalUsers2", 0, 658, 3000);
    animateValue("totalConnections", 0, 9542, 12000);
    animateValue("totalConnections2", 0, 9542, 12000);
  }, []);
